...
class TestPTR(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.looped_undirected_input = np.array([[0.5, 1, 60, 60], 
                                                ...
                                                [60, 400, 20, 80],
                                                [60, 0, 80, 0]])
        cls.loopless_directed_input = np.array([[0, 1, 60, 60], 
                                                [1, 0, 400, 0],
                                                [3, 600, 0, 80],
                                                [20, 0, 401, 0]])
        cls.looped_directed_input = np.array([[21, 1, 60, 60], 
                                              [1, 0, 400, 0],
                                              [3, 600, 0, 80],
                                              [20, 0, 401, 30]])
    ...
    def test_zeroboost_loopless_directed(self):
        ptr_expected = np.array([[0, 3.5, 7.5, 7.5],
                                 [3.5, 0, 10, 0],
                                 [5, 12, 0, 9],
                                 [6, 0, 11, 0]])
        ptr_expected /= 12
    ...
    def test_zeroboost_looped_directed(self):
        ptr_expected = np.array([[9, 5.5, 11.5, 11.5],
                                 [5.5, 0, 14, 0],
                                 [7, 16, 0, 13],
                                 [8, 0, 15, 10]])
        ptr_expected /= 16
    ...
    def test_simpleall_loopless_directed(self):
        ptr_expected = np.array([[0, 0.1764706, 0.6470588, 0.6470588],
    ...
    def test_simpleall_looped_directed(self):
        ptr_expected = np.array([[0.5882353, 0.1764706, 0.8823529, 0.8823529],
    ...
    def test_simplenonzero_loopless_directed(self): 
        ptr_expected = np.array([[0, 0.2727273, 1, 1],
    ...
    def test_simplenonzero_looped_directed(self): 
        ptr_expected = np.array([[0.7692308, 0.2307692, 1.1538462, 1.1538462],
