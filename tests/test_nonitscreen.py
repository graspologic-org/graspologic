...
def test_non_itss_mgc():
    ...
    # Testing mgc
    screen = NonItScreen("mgc")
    screen.fit(data_test, y_label_test)

    cor_vals_samp = screen.corrs
    S_hat_samp = screen.fit_transform(data_test, y_label_test, float("-inf"))
