...
def nominal_colors(
    ...
    thematic_, otherwise it will use the theme packaged with this library.

    Colors will be different when selecting for a light background vs. a dark
    background, using the principles defined by thematic.
    ...
    theme_path : Optional[str]
        ...
        you can generate one with thematic_ and provide the path to it to override
        the bundled theme.
    ...
    .. _thematic: https://microsoft.github.io/thematic/
