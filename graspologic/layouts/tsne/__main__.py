...
def _main():
    ...
    parser.add_argument("--edge_list", help="CSV file in the formate of (source,target,weight) with the first line a header", required=True)
    parser.add_argument("--layout_type", help='Valid types "autolayout", "n2vumap" (default), and "n2vtsne", others may be added', required=False, default="n2vumap")
    ...
    parser.add_argument("--max_edges", help='Maximum edges to keep during embedding (default 10000000)', type=int, required=False, default=10000000)
    ...
    from .layout_from_edges import layout_node2vec_umap_from_file, layout_node2vec_tsne_from_file
    ...
    if layout_type == 'n2vumap':
        layout_node2vec_umap_from_file(edge_list_file, image_file, location_file, dpi, max_edges)
    elif layout_type == 'n2vtsne':
        layout_node2vec_tsne_from_file(edge_list_file, image_file, location_file, dpi, max_edges)
