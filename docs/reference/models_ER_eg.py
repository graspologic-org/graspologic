...
[docs]class EREstimator(SBMEstimator):
    ...
    Examples
    ---------
    Generate a binary Erdos Renyi (n, p) graph:
    >>> G1 = er_np(10, 0.3)
    ...
    To show the estimated probability matrix:
    >>> model.p-mat_
    array([[0.   0.28 0.28 0.28 0.28 0.28 0.28 0.28 0.28 0.28]
           [0.28 0.   0.28 0.28 0.28 0.28 0.28 0.28 0.28 0.28]
           [0.28 0.28 0.   0.28 0.28 0.28 0.28 0.28 0.28 0.28]
           [0.28 0.28 0.28 0.   0.28 0.28 0.28 0.28 0.28 0.28]
           [0.28 0.28 0.28 0.28 0.   0.28 0.28 0.28 0.28 0.28]
           [0.28 0.28 0.28 0.28 0.28 0.   0.28 0.28 0.28 0.28]
           [0.28 0.28 0.28 0.28 0.28 0.28 0.   0.28 0.28 0.28]
           [0.28 0.28 0.28 0.28 0.28 0.28 0.28 0.   0.28 0.28]
           [0.28 0.28 0.28 0.28 0.28 0.28 0.28 0.28 0.   0.28]
